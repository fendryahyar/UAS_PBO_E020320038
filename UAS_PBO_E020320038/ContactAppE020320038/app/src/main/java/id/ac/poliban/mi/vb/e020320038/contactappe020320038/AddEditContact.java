...
public class AddEditContact extends AppCompatActivity {
    ...
    private void saveData() {
        ...
        if (!name.isEmpty() || !phone.isEmpty() || !email.isEmpty() || !note.isEmpty()){
            ...
            if (isEditMode){
                ...
                Toast.makeText(getApplicationContext(), "Inserted Successfully.... "+id,
                        Toast.LENGTH_SHORT).show();
            }
    ...
    private void requestCameraPermission(){
        ...
        //handle request permission on override method
    }
                ...
                if (grantResults.length >0){
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(getApplicationContext(),
                                "Camera & Storage Permission needed..", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            ...
            case STORAGE_PERMISSION_CODE:
                if (grantResults.length >0){
                    ...
                    if (storageAccepted){
                        ...
                        //permission not granted
                        Toast.makeText(getApplicationContext(), "Storage Permission needed..",
                                Toast.LENGTH_SHORT).show();
                    }
                }
                break;
