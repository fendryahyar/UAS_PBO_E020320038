package id.ac.poliban.mi.vb.e020320038.contactappe020320038;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void updateContact(String id,String image,String name,String phone,String email,
                              String note,String addedTime,String updatedTime){
        ...
        db.update(Constants.TABLE_NAME,contentValues,Constants.C_ID+" =? ",
                new String[]{id} );
    ...
    public ArrayList<ModelContact> getSearchContact(String query){
        ...
        //query for search
        String queryToSearch = "SELECT * FROM "+Constants.TABLE_NAME+" WHERE "+Constants.C_NAME +
                " LIKE '%" +query+"%'";
