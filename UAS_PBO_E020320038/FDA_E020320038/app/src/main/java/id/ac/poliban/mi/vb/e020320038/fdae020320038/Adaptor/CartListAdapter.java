package id.ac.poliban.mi.vb.e020320038.fdae020320038.Adaptor;
...
import id.ac.poliban.mi.vb.e020320038.fdae020320038.Domain.FoodDomain;
import id.ac.poliban.mi.vb.e020320038.fdae020320038.Helper.ManagementCart;
import id.ac.poliban.mi.vb.e020320038.fdae020320038.Interface.ChangeNumberItemsListener;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CartListAdapter.ViewHolder holder, int position) {
        ...
        holder.totalEachItem.setText(String.valueOf(Math.round((
                foodDomains.get(position).getNumberInCart() * foodDomains.get(position)
                        .getFee()) * 100) / 100));
        holder.num.setText(String.valueOf(foodDomains.get(position).getNumberInCart()));

        int drawableResourceId = holder.itemView.getContext().getResources().getIdentifier(
                foodDomains.get(position).getPic() , "drawable",
